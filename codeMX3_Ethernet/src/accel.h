...
extern uint32_t compteur_interrupt;
extern uint32_t compteur_interrupt2;
extern uint32_t compteur_packet;
extern char accel_packet[484];
extern bool flag_packet;
