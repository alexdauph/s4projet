...
void hex_to_ASCII(char *MSB, char *LSB, char Hexa)
{
    unsigned char temp;
...
void LCDTask(int val)
{
    ...
    int i = 0;
        ...
        hex_to_ASCII(pointeurA, pointeurB, (char)(val >> 24));
        tableau[0] = MSB;
        tableau[1] = LSB;
        hex_to_ASCII(pointeurA, pointeurB, (char)(val >> 16));
        tableau[2] = MSB;
        tableau[3] = LSB;
        hex_to_ASCII(pointeurA, pointeurB, (char)(val >> 8));
        tableau[4] = MSB;
        tableau[5] = LSB;
        hex_to_ASCII(pointeurA, pointeurB, (char)(val));
        tableau[6] = MSB;
        tableau[7] = LSB;
        
        tableau[8] = '\0';
        
        LCD_WriteStringAtPos(tableau, 0, 0);
